...
class Model:
    ...
    def predict_sequences_multiple(self, data, window_size, prediction_len, prediction_interval):
        # Predict sequence of 50 steps before shifting prediction run forward by 50 steps
        print("[Model] Predicting Sequences Multiple...")
        prediction_seqs = []
        for i in range(int(len(data) / prediction_interval)):
            curr_frame = data[i * prediction_interval]
            predicted = []
